...
Each package is developed alongside my published research — the papers ship with code you can run, and the code carries the exact methodology of the papers. <!-- TOTALS_START -->1006 stars and 182 forks across the 9 repositories.<!-- TOTALS_END -->
