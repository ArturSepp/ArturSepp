...
Each package is developed alongside my published research — the papers ship with code you can run, and the code carries the exact methodology of the papers. <!-- TOTALS_START -->1010 stars and 183 forks across the 9 repositories.<!-- TOTALS_END -->
