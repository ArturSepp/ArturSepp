...
Developed alongside my published research, these packages provide runnable implementations of the methods described in the papers. <!-- TOTALS_START -->Together, the repositories have received more than 1,000 stars and 189 forks.<!-- TOTALS_END -->
...
| [factorlasso](https://github.com/ArturSepp/factorlasso) (factorlasso) | Sparse factor models with sign-constrained LASSO | [![](https://img.shields.io/pypi/v/factorlasso?style=flat-square&label=&color=blue)](https://pypi.org/project/factorlasso/) | **[25](https://github.com/ArturSepp/factorlasso/stargazers)** | **[5](https://github.com/ArturSepp/factorlasso/network/members)** | **[10k](https://pepy.tech/project/factorlasso)** | **[29k](https://pepy.tech/project/factorlasso)** |
