...
Each package is developed alongside my published research — the papers ship with code you can run, and the code carries the exact methodology of the papers. <!-- TOTALS_START -->975 stars and 171 forks across the 9 repositories.<!-- TOTALS_END -->
...
<<<<<<< HEAD
=======
>>>>>>> ef3f31564718dde5c7452018777954e0a5463ccc
