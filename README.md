...
Developed alongside my published research, these packages provide runnable implementations of the methods described in the papers. <!-- TOTALS_START -->Together, the repositories have received more than 1,000 stars and 194 forks.<!-- TOTALS_END -->
...
| [TrendFollowingSystems](https://github.com/ArturSepp/TrendFollowingSystems) (trendfollowing) · [Docs](https://trendfollowingsystems.readthedocs.io) | Closed-form trend-following analytics | [![](https://img.shields.io/pypi/v/trendfollowing?style=flat-square&label=&color=blue)](https://pypi.org/project/trendfollowing/) | **[26](https://github.com/ArturSepp/TrendFollowingSystems/stargazers)** | **[7](https://github.com/ArturSepp/TrendFollowingSystems/network/members)** | **[1k](https://pepy.tech/project/trendfollowing)** | **[3k](https://pepy.tech/project/trendfollowing)** |
